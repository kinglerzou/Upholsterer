    ...
    public class MessageController : BaseController
    {
        ...
        public JsonResult SendMessage(int toid, string content, int type, int statetype, int stateid)
        {
            ...
            if (type == 0)
            {
                ...
                //  //  SystemSendMail(user1.Email, "Upholsterer_私信", string.Format("{0}给你发私信了快去看看吧,<a href='http://cnwj6iapc006:81/Message/CheckPrivateMessage'>查看私信</a>", user1.UserName));
                //}
                //catch 
                //{
