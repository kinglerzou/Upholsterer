...
using Upholsterer.Migrations;

namespace Upholsterer.Models
{
    public class PrivateDb:DbContext
    {
        ...
        public PrivateDb() : base(DbNameOrDbConnectionstring)
        {
            Database.SetInitializer(new MigrateDatabaseToLatestVersion<PrivateDb, Configuration<PrivateDb>>());
        }
    }
}
